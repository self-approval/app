...
describe("self-approve bot", () => {
  ...
  test("Comment is created by user not in whitelist", async () => {
    const payload = require("./fixtures/pull_request.commented.not-in-whitelist.json");
    const config = "self_approval_comments:\n  - \"I self-approve!\"\nfrom_author:\n  - Octocat\napply_labels:\n  - \"can-be-merged\"";
  ...
  test("Pull Request is approved", async () => {
  ...
  test("Pull Request is approved and label is added", async () => {
    const payload = require("./fixtures/pull_request.commented.approved.json");
    const config = "self_approval_comments:\n  - \"I self-approve!\"\nfrom_author:\n  - Cubik65536\napply_labels:\n  - \"can-be-merged\"";
